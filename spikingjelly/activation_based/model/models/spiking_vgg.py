...
# --- for visualization, track the gradient of surrogate
#import neuron

# --- for training, use standard fire-surrogate
...
__all__ = [
    ...
    'spiking_vgg25','spiking_vgg25_bn',     # --- does not work
